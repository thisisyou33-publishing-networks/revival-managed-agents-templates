...
4. **Caching & Snapshot Maintenance**: Creates or updates `/workspace/snapshots.json` with mapping and timestamp.
5. **Corpus Directory Index**: Automatically generates `./workspace/pages/index.md` listing and explaining all files in a structured, clickable table format so agents can locate matching topics immediately.
