...
An AI agent that processes expense documents and invoices. It reconciles expenses against invoices, generates videos highlighting top vendors, and creates HTML slideshow reports — all powered by Gemini.
